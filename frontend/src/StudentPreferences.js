      ...
      <main className={classes.content}>
        ...
        <form className={classes.form} noValidate>
          ...
          <FormControl component="fieldset" className={classes.formControl}>
            ...
            <FormHelperText>
              At least 1 language/skill for frontend and backend
            </FormHelperText>
          </FormControl>
          ...
          <FormControl component="fieldset" className={classes.formControl}>
            ...
            <FormHelperText>
              Each group needs at least 1 of each role
            </FormHelperText>
          </FormControl>
          <FormControl component="fieldset">
            ...
            >
              <FormControlLabel
                value="1.	Online Shopping Website"
                control={<Radio />}
                label="1. Online Shopping Website"
              />
              <FormControlLabel
                value="2.	Health Service Mobile Application"
                control={<Radio />}
                label="2. Health Service Mobile Application"
              />
              <FormControlLabel
                value="3.	Messaging Mobile Application"
                control={<Radio />}
                label="3.	Messaging Mobile Application"
              />
              <FormControlLabel
                value="4.	Restaurant Booking Website"
                control={<Radio />}
                label="4. Restaurant Booking Website"
              />
              <FormControlLabel
                value="5.	Weather Website"
                control={<Radio />}
                label="5. Weather Website"
              />
            </RadioGroup>
          </FormControl>
          {/* <FormControlLabel
